...
public class ColorSelectProcessorSingleImage {
	private static ColorSelectProcessorSingleImage selectProcessor;
	...
	public static class CSPInstance{
		public static ColorSelectProcessorSingleImage getInstance(ImageProcessor ip, int refColor, int distance){
			if(ColorSelectProcessorSingleImage.selectProcessor == null){
				ColorSelectProcessorSingleImage.selectProcessor = new ColorSelectProcessorSingleImage(ip, distance);
			}
			...
			return ColorSelectProcessorSingleImage.selectProcessor;
		}
	}
	
	private ColorSelectProcessorSingleImage(ImageProcessor ip, int distance){
		this.ip = ip;
