...
public class ColorSelectMouse implements PlugInFilter, MouseListener, MouseMotionListener {
    ...
    public void mousePressed(MouseEvent e) {
        ...
        ColorSelectMouseProcessor csp = new ColorSelectMouseProcessor(this.img.getProcessor(), this.img.getProcessor().getPixel(x, y), this.distance);
