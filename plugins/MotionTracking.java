...
public class MotionTracking implements PlugIn {
	...
	private ImageMergerProcessor imMergeProc;	
	private int thrM;
	...
	public void run(String arg0) {
		...
		try {
			this.imMergeProc = new ImageMergerProcessor(this.chDiffProc);
		}catch(ImagesNotProcessedException e){
			IJ.log(e.getMessage());
			return;
		}
		
		ImagePlus imMerge = this.thr(this.imMergeProc.merge(ImageMergerProcessor.Type.TYPE_MIN));
		imMerge.show();
